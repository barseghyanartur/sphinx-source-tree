...
try:
    import sphinx_source_tree

    version = sphinx_source_tree.__version__
    project = sphinx_source_tree.__title__
    copyright = sphinx_source_tree.__copyright__
    author = sphinx_source_tree.__author__
except ImportError:
    version = "0.1"
    project = "sphinx-source-tree"
